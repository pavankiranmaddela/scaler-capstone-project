...
@Tag(name = "Variant Listings", description = "Manage sellable SKUs (Trim + Battery + Charger) — Group 3")
class VariantListingController {
    ...
    public ResponseEntity<VariantListingResponse> createVariantListing(
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(service.createVariantListing(request));
    }
    ...
    public ResponseEntity<PagedVariantResponse> getVariantListings(
        ...
        return ResponseEntity.ok(service.getVariantListings(filters));
    }
    ...
    public ResponseEntity<VariantListingResponse> getVariantListingById(@PathVariable UUID variantId) {
        return ResponseEntity.ok(service.getVariantListingById(variantId));
    }
    ...
    public ResponseEntity<List<VariantListingResponse>> getByModel(
        ...
        return ResponseEntity.ok(service.getVariantListingsByModel(modelId, status));
    }
    ...
    public ResponseEntity<VariantListingResponse> updateVariantListing(
        ...
        return ResponseEntity.ok(service.updateVariantListing(variantId, request));
    }
